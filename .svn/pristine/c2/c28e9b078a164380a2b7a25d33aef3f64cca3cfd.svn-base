...
<section class="merright">
    ...
    <div class="merlibox1-1">
        ...
        <div class="odrbox1-1 shipListPharm">
            <div class="odrbox1-1-1 mt40">
                <p>조회기준일</p>
                <select name="c_date" id="c_date" class="selectType1">
                ...
                <select name="c_decoc" id="c_decoc" class="selectType1">
<!--                    <option value="">원</option>-->
                ...
                <select name="c_status" id="c_status" class="selectType1">
                    <!--                    <option value="">원</option>-->
                    <option value="">전체</option>
...
<!--                    <option value="바른한방">발송완료</option>-->
        ...
        <div class="shipBox ">
            <button class="btnTypeTItle">발송대기 목록</button>
<!--            <button class="btntype1">출하취소</button>-->
        ...
        <div class="shipBox shipBox1-3">
            <button class="btnTypeTItle">발송대기 상세</button>
            <button class="btnType4" onclick="">출하취소</button>
        </div>
