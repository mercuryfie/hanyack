            ...
            <div class="hbox1-3 gnb_area">
                <div class="top_menu_wrap">
                    <ul class="top_gnb_ul flexType1">
                        ...
                        <? if ($header['mitype'] == AUTH_DECOC) { ?>
                            <li>
                                <a href="javascript:;" class=" top_menu down_1" onclick="go_dashBoard();">대시보드</a>
                            </li>
                            <li>
                                <a href="javascript:;" class="top_menu down_2 highlight" onclick="go_smart();">스마트오더</a>
                            </li>
                        <? } ?>
                        <li>
                            <a href="javascript:;" class="top_menu down_3" onclick="go_orderList();">주문관리</a>
                        </li>

                        <? if ($header['mitype'] == AUTH_DECOC) { ?>
                            <li>
                                <a href="javascript:;" class="top_menu down_4" onclick="go_stock();">약재관리</a>
                            </li>
                        <? } else { ?>
                            <li>
                                <a href="javascript:;" class="top_menu down_4" onclick="go_herbList();">약재관리</a>
                            </li>
                        <? } ?>
                        <li>
                            <a href="javascript:;" class="top_menu down_5">정산관리</a>
                        </li>
                        <li>
                            <a href="javascript:;" class="top_menu down_6">나의정보</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="sub_menu_wrap flexType1">
                    <? if ($header['mitype'] == AUTH_DECOC) { ?>
                        ...
                        <div class="sub_menu_box flexCol2-2">
