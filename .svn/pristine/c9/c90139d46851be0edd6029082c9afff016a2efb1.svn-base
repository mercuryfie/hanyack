        ...
        <div class="rightBox  burkOrderForm_wrap">
            <div class="firstBox">
                ...
                <div class="infobox">
                    <div class="merinfo ">
                        ...
                        <div class="herbbox">
                            <div class="herbbtn1-1 flexType3">
                                <input type="search" class="searchInput" id="txtHD" name="txtHD"
                                       placeholder="검색어 입력 후, 엔터를 누르세요." onfocus="ini_Form1();">
                    ...
                    <div class="merinfo ">
                        <p class="title">구독기간</p>
                        <select name="" id="" class="data">
                    ...
                    <div class="merinfo ">
                        ...
                        <input type="number" name="txtpPrice" id="txtpPrice" class="inputType240" placeholder="숫자만 입력"
                               oninput="if(this.value.length > 8) this.value = this.value.slice(0,8);">
                        <p class="unit">원</p>
                    </div>
                    <div class="merinfo ">
                        <p class="title">총 박스수</p>
                        <input type="number" name="txttBox" id="txttBox" class="inputType240" placeholder="숫자만 입력"
            ...
            <div class="lastBox">
                <button type="button" class="btnType3" onclick="go_orderList()">목록</button>
                <button type="button" id="submitBtn" name="submitBtn" class="btnType4" data-hncode="" data-boxcnt=""
                        data-wicode="">확인
                </button>
            </div>
    </section>
