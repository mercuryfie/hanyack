            ...
            if (Cnt > 0) {
                $.each(arr, function(index, el) {
                    ...
                    if (goodsCount == 1) {
                        ...
                        if (item.gd_status == 0) {
                            order_str = `미확인`;
                            cancel_str = `<button type="button" class="btnType1 cancel" onclick="show_cancelOrder('${item.gd_code}');">주문취소</button>`;
                            busType_css = `busColor2`;
                            busTrack = `
                                <div class="busBox flexType2 "> 
                                    <i class="fa-solid fa-van-shuttle ${busType_css}"></i>
                            ...
                            order_str = `제품준비중`;
                            cancel_str = `<button type="button" class="btnType1 cancel" onclick="show_Delivery('${item.gd_code}');">배송현황</button>`;
                            busType_css = `busColor2`;
                            busTrack = `
                                <div class="busBox flexType2 "> 
                                    <i class="fa-solid fa-van-shuttle ${busType_css}"></i>
                        ...
                        if(item.hn_method_str=='일반구매'){
                            buyType_css = 'colorChip1';
                        }else if(item.hn_method_str=='정기구독'){
                        ...
                        html_sub = `
                                <div class="flexType3" name="block">
                                    <div class="decodrbb1-2-2"> 
                                          <div class="buyType flexType2">  
                                            ...
                                            <p class="type mr10">${typeText}</p>   
                                          </div>
                                          <div class="priceBox">
                                            <p class="status2">${order_str}</p>  
                                    ...
                                    <div class="btnBox flexType6">
                                         ${cancel_str}
                                         <button type="button" class="btnType1 mr10" onclick="">
                                            <i class="fa-solid fa-cart-shopping fontColor1" onclick="set_myCart(${item.gd_code});"></i>
                                         </button>      
                        ...
                        $.each(goods, function(idx, item) {
                            ...
                            if (item.gd_status == 0) {
                                ...
                                busTrack = `
                                <div class="busBox flexType2 "> 
                                    <i class="fa-regular fa-hourglass-half ${busType_css}"></i>
                                    <i class="fa-solid fa-receipt "></i> 
                                    <i class="fa-solid fa-van-shuttle"></i> 
                                    <i class="fa-solid fa-box"></i> 
                                    <i class="fa-solid fa-boxes-stacked"></i>
                                    <i class="fa-solid fa-van-shuttle"></i>
                                    <i class="fa-solid fa-circle-check fff"></i> 
                                </div>
                            `;
                            }else if (item.gd_status == 1) {
                                order_str = `제품준비중`;
                                ...
                                <div class="busBox flexType2 "> 
                                    ...
                                    <i class="fa-solid fa-receipt ${busType_css}"></i> 
                                    <i class="fa-solid fa-box"></i> 
                                    <i class="fa-solid fa-boxes-stacked"></i>
                                    <i class="fa-solid fa-van-shuttle"></i>
                                    <i class="fa-solid fa-circle-check fff"></i> 
                            ...
                            `;
                                ...
                                <div class="busBox flexType2 "> 
                                    <i class="fa-regular fa-hourglass-half "></i>
                                    <i class="fa-solid fa-receipt "></i> 
                                    <i class="fa-solid fa-box ${busType_css}"></i> 
                                    <i class="fa-solid fa-boxes-stacked"></i>
                                    <i class="fa-solid fa-van-shuttle"></i>
                                    <i class="fa-solid fa-circle-check fff"></i> 
                                </div>
                            `;
                                ...
                                <div class="busBox flexType2 "> 
                                    ...
                                    <i class="fa-solid fa-receipt "></i> 
                                    <i class="fa-solid fa-box"></i> 
                                    <i class="fa-solid fa-boxes-stacked ${busType_css}"></i>
                                    <i class="fa-solid fa-van-shuttle"></i>
                                    <i class="fa-solid fa-circle-check fff"></i> 
                                </div>
                            `;
                            ...
                            `;
                                ...
                                <div class="busBox flexType2 "> 
                                    ...
                                    <i class="fa-solid fa-boxes-stacked"></i>
                                    <i class="fa-solid fa-van-shuttle"></i>
                                    <i class="fa-solid fa-circle-check fff ${busType_css}"></i> 
                                </div>
                            `;
                            }
                            ...
                            html_sub += `
                                        <div class="flexType3 ${indexstr}" name="block">
                                            <div class="decodrbb1-2-2">  
                                                  <div class="buyType flexType2">
                                                    <p class="type2 ${buyType_css}">${item.hn_method_str}</p>
