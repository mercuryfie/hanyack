 ...
 */
define('SESSION_KEY','dj_Sstr');
define('COOKIE_KEY','dj_Cstr');
...
define('SECURITY_KEY','WMY784FY2ZPS8RGPZ82MHQ3K38NIEGP7');

define("AUTH_PHARM","pharm");
define("AUTH_DECOC","decoc");
define("AUTH_MASTER","master");
define("URL_PHARM","/Mypharm");
define("URL_Decoc","/Mydecoc");
define("URL_MASTER","/Mypage");
define("URL_DECOC_ASSETS","/assets/web/js/decoc");
define("URL_PHARM_ASSETS","/assets/web/js/pharm");
define("URL_COMMON_ASSETS","/assets/web/js/common");
define("URL_MASTER_ASSETS","/assets/web/js/master");
define("URL_MOBILE_ASSETS", "/assets/web/js/mobile");
define("URL_MODEL_ASSETS","/assets/web/js/model");
...
define("ORDER_TYPE_2","정기구독");
define("ORDER_TYPE_3","대량구매");
define("APIKEY","DJfHShheT88iuYgNaDvDwgF9X5kBrJ");


define("EVENT_TYPE_1","인기 한약재");
define("EVENT_TYPE_2","추천 한약재");
define("EVENT_TYPE_3","정기 구독");

define("RETURN_TYPE_1","1");
define("RETURN_TYPE_2","2");
define("RETURN_TYPE_3","3");
define("RETURN_TYPE_4","4");
