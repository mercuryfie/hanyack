...
/* Order */
$routes->GET('Order/SmartOrder','OrderController::SmartOrder');
...
$routes->match(['GET', 'POST'], 'Api/Insert_Order', 'ApiController::Insert_Order');
$routes->match(['GET', 'POST'], 'Api/Load_Order_Decoc', 'ApiController::Load_Order_Decoc');
...
$routes->match(['GET', 'POST'], 'Api/Insert_ProductEvent', 'ApiController::Insert_ProductEvent');
