...
class Member_m extends Model
{
    ...
    public function Load_Company_micode($micode,$fields=['ALL']){
    ...
    public function Load_Company_miType($mitype,$fields=['ALL']){
        $separated_val = fn_Make_Fields($fields);
        $builder = $this->db->table('herb_company');
        $builder->select($separated_val);
    ...
    public function Load_Member_Uid($uid,$fields=['ALL']){
        $separated_val = fn_Make_Fields($fields);
    ...
    public function Load_UserID_Info($Param,$fields=['ALL']){
        $separated_val = fn_Make_Fields($fields);
