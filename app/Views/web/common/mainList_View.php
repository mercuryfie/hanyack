...
<!--                <select name="" id="" class="inputType120 mr10">-->
<!--                    <option value="0">가격/재고</option>-->
<!--                    <option value="1">저가순</option>-->
<!--                    <option value="2">고가순</option>-->
<!--                    <option value="3">재고 부족순</option>-->
<!--                </select>-->
            </div>

            <div class="orderBox flexType1">
                <p class="price mr10" id="totalprice" data-tprice="0">총 0 원</p>
        ...
        <div class="sotablebox">
            <table class="sotable">
                ...
                <tr class="">
                    ...
                    <td class="socol1 herbName">약재명</td>
                    <td class="socol1 scidx1-5">시세</td>
                    ...
                    <td class="socol1 scidx1-12">구매정보</td>
