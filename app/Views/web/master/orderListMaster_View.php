        ...
        <div class="odrbox1-1 orderBoxMaster">
            ...
            <div class=" flexType3 mb10">
                ...
                <div class="right flexType2">
                    <button type="button" id="btn_deli" name="btn_deli" class="btnType4-1 mr10"
                            onclick="go_RegularOrder();">정기구독 주문
                    </button>
                    <button type="button" id="btn_deli" name="btn_deli" class="btnType4-1" onclick="go_BigOrder();">대량
                        주문
                    </button>
