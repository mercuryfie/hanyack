...
<form id="thisForm" method="post" onsubmit="return false">
    <?= $this->include("/web/include/pop_Event_View") ?>
        ...
        <div class="tableRightBox merright1-1">
            <p>필터</p>
            <div class="merli1-1">
        ...
        <div class="tableRightBox merlibox1-1">
            ...
            <div class="btnBox">
                <div class="merliauth">
                    ...
                    <button type="button" class="btnType1" id="btnSearch" name="btnSearch" data-page="1" data-cfcode="" >검색</button>

<!--                    <button type="button" class="approval" id="yakApprove" name="yakApprove" data-hncode="" data-status="">승인하기</button>-->
<!--                    <button type="button" class="cancel" id="yakCancel" name="yakCancel" data-hncode="" data-status="">승인취소</button>-->
<!--                    <button type="button" class="reject" data-hncode="hn_code" id="yakReject" name="yakReject" >반려하기</button>-->
                </div>
                <div class="merrightlast">
                    <button type="button" class="btnType1 mr10" id="yakApprove" name="yakApprove" data-hncode="" data-status="">승인하기</button>
                    <button type="button" class="btnType1 mr10" id="yakCancel" name="yakCancel" data-hncode="" data-status="">승인취소</button>
                    <button type="button" class="btnType1 mr10" data-hncode="hn_code" id="yakReject" name="yakReject" >반려하기</button>
                    <button type="button" id="btn_cancle" name="btn_cancle" class="btnType2">초기화</button>
<!--                    <button type="button" id="btn_deli" name="btn_deli">출하처리</button>-->
                </div>
            </div>
