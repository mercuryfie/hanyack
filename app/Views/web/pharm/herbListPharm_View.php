...
<section class="merright">
    ...
    <div class="common_list_wrap hlp_wrap">
        <div class="sch_box flexType3 mb10">
            <div class="cnt_box  flexType2 ">
...
<!--                    <p class="text text2 mr10 cnt_total" id="totalRs"></p>-->
<!--                    <p class="text ">개</p>-->
<!--                </div>-->
                <input type="search" class="input_search mr10"  id="keyword" placeholder="약재명을 검색하십시오.">
                <button type="button" name="" class="btnType32-2 mr10" id="btnMedicinSearch">검색</button>
            </div>
            <div class="right flexType2">
                <button  class="btnType32 mr10" id="btnSetPrice">기본 가격 설정</button>
                <button  class="btnType32-1" id="btnMedicineReg">약재 등록</button>
            </div>
        </div>
