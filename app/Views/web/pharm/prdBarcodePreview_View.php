...
<section class="content">
    <div class="modal_wrapux7" id="org_area" name="org_area">
        <div class="print_box40c">
            <div class="print_boxfv8" >
                <div id="barcodeDiv" data-pcode="<?=$body['hncode']?>" style=""></div>
            </div>
...
<!--            </div>-->
            ...
            <div class="print_boxfv6 flexType2">
                ...
                <p class="colon"> : <?=$body['address'];?></p>
            </div>
            <div class="print_boxfv6 flexType2">
                <p class="category mr10">연락처</p>
                <p class="colon"> : <?=$body['phone'];?></p>
            </div>
            <div class="print_boxfv6 flexType2">
    ...
    <div class="print_boxd2s flexType1">
        <button type="button" class="btnType3" id="btn_close" name="btn_close">취소</button>
        <button type="button" class="btnType4" id="btn_prn" name="btn_prn">출력</button>
    </div>
</section>
<?= $this->endSection() ?>
