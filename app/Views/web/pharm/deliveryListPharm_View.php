...
<!--                    </td>-->
                ...
                <?php ////= print_r($body);?>
                <!--            --><?php //foreach($body['list'] as $d) : ?>
                <!--                <tr>-->
                <!--                    <td>-->
                <!--                        <input type="checkbox" name="" id="" class="column-1">-->
                <!--                    </td>-->
                <!--                    <td class="authred">미확인</td>-->
                <!--                    <td>--><?php //=$d['hn_MakeDate'];?><!--</td>-->
                <!--                    <td>--><?php //= date('Y-m-d');;?><!--</td>-->
                <!--                    <td>--><?php //=$d['od_code'];?><!--</td>-->
                <!--                    <td>--><?php //=$d['mi_name'];?><!--</td>-->
                <!--                    <td>--><?php //=$d['hn_name'];?><!--</td>-->
                <!--                    <td>--><?php //=$d['n_value'];?><!--</td>-->
                <!--                    <td>--><?php //=$d['t1_value'];?><!--</td>-->
                <!--                    <td>--><?php //=$d['t2_value'];?><!--</td>-->
                <!--                    <td>--><?php //=$d['w_name'];?><!--</td>-->
                <!--                    <td>--><?php //=$d['hn_gPrice'];?><!--</td>-->
                <!--                    <td>--><?php //=$d['hn_pPrice'];?><!--</td>-->
                <!--                    <td></td>-->
                <!--                </tr>-->
                <!---->
                <!---->
