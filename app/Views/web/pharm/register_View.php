            ...
            <div class="rightBox merright1-3">
                ...
                <div class="infobox">
                    ...
                    <div class="merinfo infotype1">
                        <p class="must"></p>
                        <p>약재명</p>
                        <input type="text" id="o_name" name="o_name" placeholder="ex. 감초" class="inputType240">
                    </div>
                    <div class="merinfo infotype1">
                        <p class="must"></p>
                        <p>제조번호</p>
                        <input type="text" id="o_number" name="o_number" placeholder="" class="inputType240">
                    </div>
                ...
                <div class="buy_type_wrap" id="buyWrap" name="buyWrap">
                    ...
                    <div class="option_box" id="optionBox" name="optionBox">
                        <div class="option_type">
                            ...
                            <input type="text" name="hn_gPrice_1" id="hn_gPrice_1" placeholder="숫자만입력" class="inputType240">원
                        </div>
                        <div class="option_type">
                            <p class="mustStyle must"></p>
                            <p class="title">포장가격</p>
                            <input type="text" name="hn_pPrice_1" id="hn_pPrice_1" placeholder="숫자만입력" class="inputType240" readonly>원
                        </div>
                        <div class="option_type">
                            <p class="mustStyle must"></p>
                            <p class="title">재고수량</p>
                            <input type="text" name="hn_stock_1" id="hn_stock_1" placeholder="숫자만입력" class="inputType240">
                        </div>
                    </div>
                </div>
