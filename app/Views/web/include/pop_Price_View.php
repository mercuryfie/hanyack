<div class="bestpop buy_item_wrap" id="pop_buy_item" name="pop_buy_item">
    <div class="bestpopcon buy_item_conkol">
        <div class="area area1 flexType1 " >
            <p class="pop_head_title " id="pbuy_title" name="pbuy_title" data-mmcode="" data-medicode="" data-cfcode="">a</p>
        ...
        <div class="area area3 flexType3">
            <div class="search_box area2 flexCol ">
                <div class="searched_box area0 flexType2">
                    <input type="search" class="input_type mr10" placeholder="매칭 추천 약재에 없을 시 약재명을 검색하세요."
                           id="txtMatchPopSearch"
        ...
        <div class="area area2 flexType2-1">
            <div class="match_box101" >
                <p class="title fw_600">매칭 추천 약재</p>
                <div class="match_box1011">
                    <table class="buy_item_tbl match_rec flexCol" id="resMatching" name="resMatching">
                    </table>
                </div>
            </div>
            <div class="match_box102">
                <div class="flexType2">
                    <p class="title fw_600 mr20">매칭된 약재</p>
                    <p class="msg fc_main">*즉시 구매 시 익일배송됩니다.</p>
                </div>
                <div class="match_box1021">
                    <table class="buy_item_tbl match_rec flexCol" id="productList" name="productList">
                    </table>
                </div>
        ...
        <div class="area lastArea flexType1">
            <button class="btnType32" id="Xbtn2">닫기</button>
        </div>
    </div>
</div>