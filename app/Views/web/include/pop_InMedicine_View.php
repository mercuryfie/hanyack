 <div class="common_pop_wrap in_material_wrap" id="pop_inMedicine" name="pop_inMedicine">
...
<!--            </div>-->
        ...
        <div class="lastArea flexType1">
            ...
            <button class="btnType32-1" id="btnInStockDo" data-hncode="" data-hpcode="" data-vcode="">확인</button>
        </div>
    </div>
</div>