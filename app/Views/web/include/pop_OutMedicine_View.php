 <div class="common_pop_wrap out_material_wrap" id="pop_outMedicine" name="pop_outMedicine">
...
<!--        </div>-->
        ...
        <div class="lastArea flexType1">
            <button class="btnType32 mr10" id="OutXbtn2">취소</button>
            <button class="btnType32-1" id="btnOutStockDo" data-hncode="" data-hpcode="" data-vcode="">확인</button>
        </div>
    </div>
</div>