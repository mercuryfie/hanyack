...
<!--                <button class="unchecked">전체보기</button>-->
<!--                <button class="unchecked">매칭약재</button>-->
<!--              <button class="unchecked">미매칭약재</button>-->
            ...
            <div class="btnli2">
              ...
              <button type="button" id="selectView" name="selectView">선택보기</button>
              <button type="button" id="AllView" name="AllView">선택삭제</button>
            </div>
          </div>
            ...
            <div class="sotablebox">
                <table class="sotable">
                    ...
                    <tr class="">
                        ...
                        <td class="socol1 scidx1-5">옵션</td>
                        <td class="socol1 scidx1-3">제약사</td>
                        <td class="socol1 scidx1-4">약재명 / 탕전실약재명</td>
