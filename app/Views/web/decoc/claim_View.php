    ...
    <div class="decodr refund_boxtc6">
        ...
        <div class="area area2">
            <label for="claim" class="label1">
                <input type="radio" name="claim" id="" checked>교환
            </label>
            <label for="claim" class="label2">
                <input type="radio" name="claim" id="">반품 후 환불
            </label>
        </div>
        ...
        <div class="area el_boxatq flexType4">
            ...
            <div class="flexCol">
                <input type="search"
                       class="address" name="" id="" placeholder="주소">
                <input type="search"
                       class="address" name="" id="" placeholder="상세주소">
            </div>
        </div>
