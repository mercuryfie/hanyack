$(document).ready(function(){
    ...
    $(document).on('click', '#btn_minus, #btn_plus', function() {
        const $itemWrap = $(this).closest('.item_wrap');
        const $countEl = $itemWrap.find('#r_count');
        let count = parseInt($countEl.text());
        const price = parseInt($countEl.data('price'));
        ...
        $itemWrap.find('#r_total').text('총 ' + formattedPrice + '원').attr('data-tPrice', totalPrice);
    });
