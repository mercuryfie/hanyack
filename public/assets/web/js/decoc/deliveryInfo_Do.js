                ...
                <div class="newAdd flexType3 ml10" name=""> 
                        <div class="add2" name="newAddress">   
                            ...
                            <div class="tag flexType2">
                                <p class="title">주소</p>
                                <input type="text" class="inputType2 "  disabled
                                        id="" name="Add1"
                                        placeholder="hello" value="${data.roadAddress}">
                            </div>
                            <div class="tag flexType2">
                                <p class="title">상세주소</p>
                                <input type="text" class="inputType2 " 
                                        id="" name="Add2"
                                        placeholder="hello">
                            </div>
                            <div class="tag flexType2">
                                ...
                                <input type="text" 
                                        id="" name="miname"
                                        class="inputType2 " placeholder="hello">
                            </div> 
                            <div class="tag flexType2">
                                <p class="title">연락처</p>
                                <input type="text" 
                            ...
                            <input type="checkbox" class="mr10 " 
                                   name="isDefault" id="set${data.zonecode}">기본 주소지로 저장
                            </label>
                        </div> 
