...
function go_tradeMaterialList(vcode = '') {
    let uid = $('#tUid').val();
    let url = '';
    let tUrl = $('#tUrl').val();
    ...
    if (uid == '') {
        ...
        url = tUrl + '/tradeMaterialList?cd=' + vcode;

    } else {
        url = tUrl + '/tradeMaterialList';
    }
...
function go_prodList(hncode){
    ...
    if(uid==''){
        ...
        let tUrl = $('#tUrl').val();
        url = tUrl + "/prodList?cd=" + hncode;
        $(location).attr("href", url);
    }
}

function go_medicineLog(hncode){
    let uid = $('#tUid').val();
    let url = '';
    if(uid==''){
        url = '/Member/Login';
        ...
        let tUrl = $('#tUrl').val();
        url = tUrl + "/medicineLog?cd=" + hncode;
        $(location).attr("href", url);
    }
}
    ...
    switch (theme) {
        case 'simple':
            html = `
                ...
                <i class="fa-solid fa-angles-left mr10"></i>
                <i class="fa-solid fa-angle-left mr20"></i>`;
            ...
            html += `
                <i class="fa-solid fa-angle-right ml20"></i>
                <i class="fa-solid fa-angles-right ml10"></i>
                </div>`;
            break;
    }
