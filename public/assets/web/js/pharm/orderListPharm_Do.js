$(document).ready(function () {
    ...
    $(document).on('click', 'input[name="txtdel"]', function() {
        initDatepickers();
    });
            ...
            if (Cnt > 0) {
                $.each(arr, function (index, el) {
                    ...
                    if(el.gd_delidate==''){
                        ...
                        delstr2 = `<button type="button" 
                                data-status="${el.gd_status}" 
                                data-sn="${el.sn}" class="btnType1" 
                                name="inputdeli">확인</button>`;
                    }else{
