$(document).ready(function() {
    ...
    $('#qBox1').hover(
        function() { $('#bubble1').show(); },
        function() { $('#bubble1').hide(); }
    );
    $('#qBox2').hover(
        function() { $('#bubble2').show(); },
        function() { $('#bubble2').hide(); }
    );
    $('#qBox3').hover(
        function() { $('#bubble3').show(); },
        function() { $('#bubble3').hide(); }
    );
            ...
            if (Cnt > 0) {
                $.each(arr, function (index, el) {
                    ...
                    if(el.price.length > 0){
                        $.each(el.price, function (index, el2) {
                            if(el2.hn_method ==1){
                                method1 = Number(el2.hn_gPrice).toLocaleString() + '원/' + Number(el2.hn_pPrice).toLocaleString() + '원';
                            }else if(el2.hn_method ==2){
                                method2 = el2.hn_period + '개월/' + Number(el2.hn_gPrice).toLocaleString() + '원/' + Number(el2.hn_pPrice).toLocaleString() + '원' ;
                            }
                        });
                    }
                    ...
                    html += ` 
                         ...
                         <tr id="line_${el.sn}"> 
                            ...
                            <td class="authStatus" ${authStatus_css}>${authStatus_str}</td>
                            ${subHtml}
                            <td class="">${el.hn_code}</td>
                            <td>${el.hn_name}</td>
